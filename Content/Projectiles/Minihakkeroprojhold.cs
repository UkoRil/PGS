using purgaytorymemebersuggestions.Content.Items.Weapons;
...
{
	public class Minihakkeroprojhold : ModProjectile
	{
		public override string Texture => "purgaytorymemebersuggestions/Content/Items/Weapons/Minihakkero";

		private const int NumAnimationFrames = 5;

		public const int NumBeams = 10;

		public const float MaxCharge = 40f;
		...
		private const float MaxManaConsumptionDelay = 50f;
		private const float MinManaConsumptionDelay = 1f;
		...
		private void FireBeams() {
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, beamVelocity, ModContent.ProjectileType<Minihakkerobeam>(), damage, knockback, Projectile.owner, b, uuid);
			}
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Color drawColor = Minihakkero.OverrideColor;
